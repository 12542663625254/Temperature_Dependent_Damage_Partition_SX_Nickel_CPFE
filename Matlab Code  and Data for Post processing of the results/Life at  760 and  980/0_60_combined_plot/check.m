...
% =========================================================================
cases(1).filename = '980_0_30_2_4.csv'; 
cases(1).epsilon_a = 0.012;      
cases(1).exp_life = 16;           

cases(2).filename = '980_0_30_2_0.csv'; 
cases(2).epsilon_a = 0.01;      
cases(2).exp_life = 176;         

cases(3).filename = '980_0_30_1_6.csv'; 
cases(3).epsilon_a = 0.008;      
cases(3).exp_life = 318;          

cases(4).filename = '980_0_30_1_4.csv'; 
cases(4).epsilon_a = 0.007;      
...
for k = 1:length(cases)
    ...
    if isfile(current_file)
        ...
        for i = 2:length(time_col)
            ...
            if k == 1
                if (t_current > 36 && t_current <= 66), is_creep = true;
                elseif (t_current > 12 && t_current <= 36) || (t_current > 66 && t_current <= 90), is_fatigue = true; end
            elseif k == 2
                if (t_current > 30 && t_current <= 60), is_creep = true;
                elseif (t_current > 10 && t_current <= 30) || (t_current > 60 && t_current <= 80), is_fatigue = true; end
            elseif k == 3
                if (t_current > 24 && t_current <= 54), is_creep = true;
                elseif (t_current > 8 && t_current <= 24) || (t_current > 54 && t_current <= 70), is_fatigue = true; end
            elseif k == 4
                if (t_current > 21 && t_current <= 51), is_creep = true;
                elseif (t_current > 51 && t_current <= 65) || (t_current > 7 && t_current <= 21), is_fatigue = true; end
            end
