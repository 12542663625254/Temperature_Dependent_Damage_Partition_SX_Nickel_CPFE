...
c(2)=mk('pin_30_30_2_0.csv',0.010,250, 1033,[10 40;60 90],   [40 60;90 110]);
...
Dc=zeros(1,N); Df=zeros(1,N); Tvec=zeros(1,N); exp_lives=zeros(1,N);
for k=1:N
    ...
    Tvec(k)=c(k).T; exp_lives(k)=c(k).exp;
end
disp(table((1:N)',Tvec',[c.ea]',Dc',Df',exp_lives', ...
...
fprintf('========================================================\n');
disp(table((1:N)',Tvec',exp_lives',pred',err', ...
    'VariableNames',{'Case','T_K','Exp_Life','Pred_Life','Error_Pct'}));
