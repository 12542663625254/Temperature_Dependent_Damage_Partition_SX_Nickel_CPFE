...
% --- Plot 3: Combined (FINAL CLEAN VERSION) ---
% =========================================================================
...
h2 = plot(strain_33_2, stress_33_2, 'o', ...
    ...
    'MarkerSize', 12, ...
    'LineWidth', 1.5, ...
    'MarkerIndices', round(linspace(1, length(strain_33_2), 100)));
...
% =========================================================================
figure('Name','Fatigue Test: Simulated vs Experimental (High Marker Density)','Color','w');
hold on; % Ensure hold is on before drawing lines

% --- ADD ZERO-AXIS GRID LINES ---
% Using dark gray dashed lines for a professional publication look
