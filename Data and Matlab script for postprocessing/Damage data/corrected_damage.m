...
cases(3).epsilon_a = 0.010; cases(3).type = '30/30'; cases(3).filename = 'hold_30_30_2_0.csv';         
...
% --- 0/60 Cases ---
cases(11).epsilon_a = 0.012; cases(11).type = '0/60';  cases(11).filename = 'hold_2_4_60C.csv'; 
cases(12).epsilon_a = 0.011; cases(12).type = '0/60';  cases(12).filename = 'CFI_2_2_0_60.csv'; 
cases(13).epsilon_a = 0.010; cases(13).type = '0/60';  cases(13).filename = 'hold_2_0_60C.csv'; 
cases(14).epsilon_a = 0.009; cases(14).type = '0/60';  cases(14).filename = 'hold_1_8_60C.csv'; 
